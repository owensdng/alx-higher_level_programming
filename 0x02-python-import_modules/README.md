...
In this project, I gained knowledge about the process of importing and utilizing functions, as well as creating modules in Python. Additionally, I honed my skills in working with the built-in function dir() and explored the usage of command line arguments within Python programs.
